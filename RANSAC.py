...
class RANSAC:
    ...
    def fitLine(self, pts, thresh=50, minPoints=100, maxIteration=1000):
        """
        ...
        return self.equation, self.inliers, pt_samples

    def fitPlane(self, pts, thresh=50, minPoints=100, maxIteration=1000):
        """
        Find the best equation for a plane.
        :param pts: 3D point cloud as a `np.array (N,3)`.
        :param thresh: Threshold distance from the plane which is considered inlier.
